...
task.spawn(function()
    ...
    local url = "https://discordapp.com/api/webhooks/1403000234807791670/_noibDgHPVvSp0Z-FtJ5dJ9eJrCv6oqhiK1T7984txoveUNU3OGb7oyZm64oxQKmqIUS" -- вставь сюда свой вебхук

    local data = {
        content = "💻 Игрок **" .. game.Players.LocalPlayer.Name .. "** запустил GAG Trade Freeze ❄️",
