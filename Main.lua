...
-- Создаём ScreenGui и фон с градиентом
...
LoadingFrame.Size = UDim2.new(0.8,0,0.5,0)
LoadingFrame.Position = UDim2.new(0.1,0,0.25,0)
...
-- Функция создания круга-индикатора (зелёный или красный)
local function createIndicator(color)
    ...
    circle.Position = UDim2.new(1,5,0.5,0)
...
local function createMenu()
    ...
    -- Антибан кнопка с текстом
    local AntiBanFrame = Instance.new("Frame")
    AntiBanFrame.Parent = MenuFrame
    AntiBanFrame.Size = UDim2.new(1, -20, 0, 40)
    AntiBanFrame.Position = UDim2.new(0, 10, 0, 60)
    AntiBanFrame.BackgroundColor3 = Color3.fromRGB(40,40,40)
    AntiBanFrame.BorderSizePixel = 0
    local antiBanCorner = Instance.new("UICorner", AntiBanFrame)
    antiBanCorner.CornerRadius = UDim.new(0,10)

    local AntiBanText = Instance.new("TextLabel")
    AntiBanText.Parent = AntiBanFrame
    AntiBanText.Size = UDim2.new(0.7, 0, 1, 0)
    AntiBanText.Position = UDim2.new(0,10,0,0)
    AntiBanText.BackgroundTransparency = 1
    AntiBanText.Text = "ANTI BAN BYPASS"
    AntiBanText.Font = Enum.Font.GothamBold
    AntiBanText.TextColor3 = Color3.fromRGB(255,255,255)
    AntiBanText.TextScaled = true
    AntiBanText.TextXAlignment = Enum.TextXAlignment.Left
    AntiBanText.TextYAlignment = Enum.TextYAlignment.Center

    local AntiBanNote = Instance.new("TextLabel")
    AntiBanNote.Parent = AntiBanFrame
    AntiBanNote.Size = UDim2.new(0.3, -10, 1, 0)
    AntiBanNote.Position = UDim2.new(0.7, 10, 0, 0)
    AntiBanNote.BackgroundTransparency = 1
    AntiBanNote.Text = "must be on trade before using!"
    AntiBanNote.Font = Enum.Font.Gotham
    AntiBanNote.TextColor3 = Color3.fromRGB(180,180,180)
    AntiBanNote.TextScaled = false
    AntiBanNote.TextSize = 14
    AntiBanNote.TextXAlignment = Enum.TextXAlignment.Right
    AntiBanNote.TextYAlignment = Enum.TextYAlignment.Center

    -- Индикатор ANTI BAN BYPASS (скрыт по умолчанию)
    local AntiBanIndicator
    do
        AntiBanIndicator = createIndicator(Color3.fromRGB(0, 255, 0)) -- зелёный
        AntiBanIndicator.Parent = AntiBanFrame
        AntiBanIndicator.Visible = false
        AntiBanIndicator.Position = UDim2.new(1, 5, 0.5, 0)
    end

    -- Обработка клика по AntiBanFrame
    AntiBanFrame.Active = true
    AntiBanFrame.AutoButtonColor = true
    AntiBanFrame.MouseButton1Click = nil -- Это не кнопка, надо заменить на TextButton или сделать по Frame через UserInputService

    -- Лучше сделаем вместо Frame — TextButton, чтобы можно было кликать
    AntiBanFrame:Destroy()
    local AntiBanButton = Instance.new("TextButton")
    AntiBanButton.Parent = MenuFrame
    AntiBanButton.Size = UDim2.new(1, -20, 0, 40)
    AntiBanButton.Position = UDim2.new(0, 10, 0, 60)
    AntiBanButton.BackgroundColor3 = Color3.fromRGB(40,40,40)
    AntiBanButton.BorderSizePixel = 0
    AntiBanButton.AutoButtonColor = true
    local antiBanBtnCorner = Instance.new("UICorner", AntiBanButton)
    antiBanBtnCorner.CornerRadius = UDim.new(0,10)
    AntiBanButton.Font = Enum.Font.GothamBold
    AntiBanButton.TextColor3 = Color3.fromRGB(255,255,255)
    AntiBanButton.TextScaled = true
    AntiBanButton.TextXAlignment = Enum.TextXAlignment.Left
    AntiBanButton.Text = "ANTI BAN BYPASS"

    -- Подпись справа
    local AntiBanSubText = Instance.new("TextLabel")
    AntiBanSubText.Parent = AntiBanButton
    AntiBanSubText.Size = UDim2.new(0.5, -20, 1, 0)
    AntiBanSubText.Position = UDim2.new(0.5, 0, 0, 0)
    AntiBanSubText.BackgroundTransparency = 1
    AntiBanSubText.Text = "must be on trade before using!"
    AntiBanSubText.Font = Enum.Font.Gotham
    AntiBanSubText.TextColor3 = Color3.fromRGB(180,180,180)
    AntiBanSubText.TextScaled = false
    AntiBanSubText.TextSize = 14
    AntiBanSubText.TextXAlignment = Enum.TextXAlignment.Right
    AntiBanSubText.TextYAlignment = Enum.TextYAlignment.Center

    -- Индикатор зелёный справа (спрятан)
    local AntiBanCircle = createIndicator(Color3.fromRGB(0,255,0))
    AntiBanCircle.Parent = AntiBanButton
    AntiBanCircle.Visible = false
    AntiBanCircle.Position = UDim2.new(1, 5, 0.5, 0)

    AntiBanButton.MouseButton1Click:Connect(function()
        AntiBanCircle.Visible = not AntiBanCircle.Visible
    end)
    ...
    ButtonsFrame.Position = UDim2.new(0, 10, 0, 110)
    ButtonsFrame.BackgroundTransparency = 1

    local OnButton = Instance.new("TextButton")
    OnButton.Parent = ButtonsFrame
    OnButton.Size = UDim2.new(0.4, 0, 1, 0)
    ...
    OnButton.Text = "On"
    local onCorner = Instance.new("UICorner", OnButton)
    onCorner.CornerRadius = UDim.new(0, 10)

    local OffButton = Instance.new("TextButton")
    OffButton.Parent = ButtonsFrame
    OffButton.Size = UDim2.new(0.4, 0, 1, 0)
    OffButton.Position = UDim2.new(0.6, 0, 0, 0)
    ...
    OffButton.Text = "Off"
    local offCorner = Instance.new("UICorner", OffButton)
    offCorner.CornerRadius = UDim.new(0, 10)

    -- Индикаторы справа от кнопок
    local OnIndicator = createIndicator(Color3.fromRGB(0,255,0))
    OnIndicator.Parent = OnButton
    OnIndicator.Visible = false
    OnIndicator.Position = UDim2.new(1, 5, 0.5, 0)

    local OffIndicator = createIndicator(Color3.fromRGB(255,0,0))
    OffIndicator.Parent = OffButton
    OffIndicator.Visible = false
    OffIndicator.Position = UDim2.new(1, 5, 0.5, 0)

    -- Логика переключения индикаторов
    OnButton.MouseButton1Click:Connect(function()
        OnIndicator.Visible = true
        OffIndicator.Visible = false
    end)
    OffButton.MouseButton1Click:Connect(function()
        OnIndicator.Visible = false
        OffIndicator.Visible = true
    end)

    -- По умолчанию Off включён (красный индикатор)
    OffIndicator.Visible = true
    OnIndicator.Visible = false
    AntiBanCircle.Visible = false

    -- Делаем меню передвигаемым
    ...
    -- Анимация появления меню (выезд сверху)
    MenuFrame.Position = UDim2.new(0.5, -150, -0.5, -150)
    local tweenIn = TweenService:Create(MenuFrame, TweenInfo.new(0.7, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
...
spawn(function()
    ...
    -- Сворачивание загрузочного окна
    local shrinkTween = TweenService:Create(LoadingFrame, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
